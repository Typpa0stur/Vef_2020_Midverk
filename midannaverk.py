...
def index():
    ...
    return render_template("index.html", co = companyOnce,minnstiBens=minnstiBens,minnstiDis=minnstiDis,minnstiBensCo=minnstiBensCo,minnstiDisCo=minnstiDisCo,minnstiBensLo=minnstiBensLo,minnstiDisLo=minnstiDisLo)
